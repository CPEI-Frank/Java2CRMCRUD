...
public class OptionMetadataImpl extends com.microsoft.schemas.xrm._2011.metadata.impl.MetadataBaseImpl implements com.microsoft.schemas.xrm._2011.metadata.OptionMetadata
{
    ...
    private static final javax.xml.namespace.QName COLOR$0 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/xrm/2011/Metadata", "Color");
    ...
    public com.microsoft.schemas.xrm._2011.contracts.Label getDescription()
    {
        synchronized (monitor())
        {
            ...
            target = (com.microsoft.schemas.xrm._2011.contracts.Label)get_store().find_element_user(DESCRIPTION$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.microsoft.schemas.xrm._2011.contracts.Label addNewDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.contracts.Label target = null;
            target = (com.microsoft.schemas.xrm._2011.contracts.Label)get_store().add_element_user(DESCRIPTION$2);
            return target;
        }
    }
    ...
    public com.microsoft.schemas.xrm._2011.contracts.Label getLabel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.contracts.Label target = null;
            target = (com.microsoft.schemas.xrm._2011.contracts.Label)get_store().find_element_user(LABEL$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetLabel()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LABEL$6) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(label, LABEL$6, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.microsoft.schemas.xrm._2011.contracts.Label addNewLabel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.contracts.Label target = null;
            target = (com.microsoft.schemas.xrm._2011.contracts.Label)get_store().add_element_user(LABEL$6);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlInt xgetValue()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlInt)get_store().find_element_user(VALUE$8, 0);
            return target;
        }
    }
    ...
    public void xsetValue(org.apache.xmlbeans.XmlInt value)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInt)get_store().add_element_user(VALUE$8);
            }
            target.set(value);
        }
    }

...
public class LinkEntityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.xrm._2011.contracts.LinkEntity
{
    ...
    private static final javax.xml.namespace.QName ORDERS$18 = 
    ...
    public com.microsoft.schemas.xrm._2011.contracts.ArrayOfOrderExpression getOrders()
    {
        synchronized (monitor())
        {
            ...
            target = (com.microsoft.schemas.xrm._2011.contracts.ArrayOfOrderExpression)get_store().find_element_user(ORDERS$18, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetOrders()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ORDERS$18) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(orders, ORDERS$18, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.microsoft.schemas.xrm._2011.contracts.ArrayOfOrderExpression addNewOrders()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.contracts.ArrayOfOrderExpression target = null;
            target = (com.microsoft.schemas.xrm._2011.contracts.ArrayOfOrderExpression)get_store().add_element_user(ORDERS$18);
            return target;
        }
    }
    ...
    public void unsetOrders()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ORDERS$18, 0);
        }
    }
}

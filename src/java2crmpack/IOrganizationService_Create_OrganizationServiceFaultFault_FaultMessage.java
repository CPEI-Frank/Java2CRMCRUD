...
public class IOrganizationService_Create_OrganizationServiceFaultFault_FaultMessage
    extends java.lang.Exception {
    private static final long serialVersionUID = 1464415254032L;
    private com.microsoft.schemas.xrm._2011.contracts.OrganizationServiceFaultDocument faultMessage;

    public IOrganizationService_Create_OrganizationServiceFaultFault_FaultMessage() {
        super(
